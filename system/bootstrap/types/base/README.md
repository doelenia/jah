...
**Agents:** read this file when creating a new type or any `instance.yaml`. Run **Type coherence review** (`system/agent/type_system.md`) before any type or instance shape change.
