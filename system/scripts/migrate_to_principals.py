...
def path_replacements(principal_id: str) -> list[tuple[str, str]]:
    return [
        ...
        ("tools/scripts/", f"users/{principal_id}/tools/scripts/"),
        ("tools/", f"users/{principal_id}/tools/"),
    ]
...
def main() -> int:
    ...
    tools_dst = principal_dir / "tools"
    scripts_dst = tools_dst / "scripts"
    scripts_dst.mkdir(parents=True, exist_ok=True)

    prebuilt_scripts = root / "users" / principal_id / "tools" / "scripts"
